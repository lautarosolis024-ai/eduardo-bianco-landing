          ...
          >
            <div ref={dialogRef} className="liquid-glass rounded-2xl p-6 sm:p-8 max-w-md w-full pointer-events-auto relative">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full bg-[#1B3A5C] hover:bg-[#2A5A8A] text-white rounded-xl py-3.5 text-sm font-semibold transition-all hover:scale-[1.02] active:scale-[0.98] min-h-[48px] cta-primary"
              >
